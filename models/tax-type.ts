 ...
 * @enum {string}
 */
export type TaxType = 'F3MEDA' | 'F3SS' | 'FCAP' | 'FEIC' | 'FESL' | 'FMEDA' | 'FMISC' | 'FSOCER' | 'FSS' | 'FSSERC' | 'FUTA' | 'FWH' | 'FWH945' | 'LCITY' | 'LCITYN' | 'LCITYR' | 'LCITYS' | 'LCNTY' | 'LCNTYN' | 'LCNTYR' | 'LMISC' | 'LSDIT' | 'OLDCODE' | 'SDI' | 'SMISC' | 'SUI' | 'SUR' | 'SWC' | 'SWH'
