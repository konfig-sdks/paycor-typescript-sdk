...
import { EmployeeStatusData2 } from './employee-status-data2';
 ...
 * @export
 * @interface OnDemandPayDeductionInformation
 */
export interface OnDemandPayDeductionInformation {
    /**
     * Unique identifier of the Legal Entity in Paycor\'s system.
     * @type {number}
     * @memberof OnDemandPayDeductionInformation
     */
     ...
     * @memberof OnDemandPayDeductionInformation
     */
    'ImpoundProcessDate'?: string | null;
    /**
     * Unique number of impound reference.             
     * @type {string}
     * @memberof OnDemandPayDeductionInformation
     */
    'ImpoundReferenceId'?: string | null;
    /**
     * Flag that shows information of impounded amount.             
     * @type {number}
     * @memberof OnDemandPayDeductionInformation
     */
    'ImpoundedAmount'?: number;
    /**
