 ...
 * @export
 * @interface PagedResultOfEmployeeCertification
 */
export interface PagedResultOfEmployeeCertification {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeCertification
     */
     ...
     * @type {Array<EmployeeCertification>}
     * @memberof PagedResultOfEmployeeCertification
     */
    'Records'?: Array<EmployeeCertification> | null;
}
