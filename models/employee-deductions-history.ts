...
import { EmployeeDeductionHistoryItem } from './employee-deduction-history-item';

/**
 * 
 * @export
 * @interface EmployeeDeductionsHistory
 */
export interface EmployeeDeductionsHistory {
    /**
     * Sum of all deduction amounts in DeductionHistoryItems collection.
     * @type {number}
     * @memberof EmployeeDeductionsHistory
     */
    'TotalDeductionsAmount'?: number | null;
    /**
     * List of Deductions.
     * @type {Array<EmployeeDeductionHistoryItem>}
     * @memberof EmployeeDeductionsHistory
     */
    'DeductionHistoryItems'?: Array<EmployeeDeductionHistoryItem> | null;
}
