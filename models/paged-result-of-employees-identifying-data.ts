...
import { EmployeesIdentifyingData } from './employees-identifying-data';
 ...
 * @export
 * @interface PagedResultOfEmployeesIdentifyingData
 */
export interface PagedResultOfEmployeesIdentifyingData {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeesIdentifyingData
     */
     ...
     * @type {Array<EmployeesIdentifyingData>}
     * @memberof PagedResultOfEmployeesIdentifyingData
     */
    'Records'?: Array<EmployeesIdentifyingData> | null;
}
