 ...
 * @enum {string}
 */
export type PayFrequency = 'EveryPayPeriod' | 'FirstPayPeriodOfMonth' | 'SecondPayPeriodOfMonth' | 'ThirdPayPeriodOfMonth' | 'FourthPayPeriodOfMonth' | 'EveryNotThirdNotFifth' | 'FirstAndThirdPayPeriod' | 'SecondAndFourthPayPeriod' | 'LastPayPeriod' | 'SpecialOccurrence' | 'FirstAndSecondPayPeriod'
