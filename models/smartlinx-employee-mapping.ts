 ...
 * @export
 * @interface SmartlinxEmployeeMapping
 */
export interface SmartlinxEmployeeMapping {
    /**
     * Unique identifier of the employee in Paycor system.
     * @type {string}
     * @memberof SmartlinxEmployeeMapping
     */
