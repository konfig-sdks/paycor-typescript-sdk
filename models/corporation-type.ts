 ...
 * @enum {string}
 */
export type CorporationType = 'Corporation' | 'SolePropLLC' | 'LLC' | 'PartnershipLLC' | 'EstateTrust' | 'Unincorporated' | 'Railroad' | 'CommonPaymaster' | 'Seasonal' | 'Successorship' | 'Government' | 'CERS' | 'PERS' | 'MQGE' | 'FICATaxable' | 'FICAExempt' | 'NonProfit' | 'Reimbursing' | 'Clergy' | 'Agricultural' | 'Household' | 'IndContractor' | 'TenNinetyNineR' | 'TenNinetyNineIGDB' | 'SCorp' | 'CCorp' | 'ThirdPartyPayer'
