 ...
 * @export
 * @interface PagedResultOfGeneralLedger
 */
export interface PagedResultOfGeneralLedger {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfGeneralLedger
     */
     ...
     * @type {Array<GeneralLedger>}
     * @memberof PagedResultOfGeneralLedger
     */
    'Records'?: Array<GeneralLedger> | null;
}
