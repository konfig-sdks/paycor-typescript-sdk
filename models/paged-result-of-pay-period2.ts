...
import { PayPeriod2 } from './pay-period2';
 ...
 * @export
 * @interface PagedResultOfPayPeriod2
 */
export interface PagedResultOfPayPeriod2 {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfPayPeriod2
     */
     ...
     * @type {Array<PayPeriod2>}
     * @memberof PagedResultOfPayPeriod2
     */
    'Records'?: Array<PayPeriod2> | null;
}
