 ...
 * @export
 * @interface PagedResultOfScheduleGroup
 */
export interface PagedResultOfScheduleGroup {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfScheduleGroup
     */
     ...
     * @type {Array<ScheduleGroup>}
     * @memberof PagedResultOfScheduleGroup
     */
    'Records'?: Array<ScheduleGroup> | null;
}
