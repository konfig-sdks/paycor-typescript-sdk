 ...
 * 
 * @export
 * @interface CancelOnDemandPayResult
 */
export interface CancelOnDemandPayResult {
    /**
     * 
     * @type {number}
     * @memberof CancelOnDemandPayResult
     */
    'OriginalPayImportId'?: number;
    /**
     * 
     * @type {number}
     * @memberof CancelOnDemandPayResult
     */
    'CancellationPayImportId'?: number;
}
