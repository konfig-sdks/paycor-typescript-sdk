 ...
 * @enum {string}
 */
export type ListCDocument = 'SocialSecurityAccountNumber' | 'CertificateOfBirthDS1350orFS545FS240' | 'CertificationOfBirthAbroadFS545' | 'CertificateOfReportOfBirthDS1350' | 'ConsularReportOfBirthAbroadFS240' | 'USBirthCertificate' | 'NativeAmericanTribalDoc' | 'USCitizenIDCardI197' | 'IDCardForResidentCitizenI179' | 'EmploymentAuthorisationDocumentDHS' | 'ReceiptSocialSecurityAccountNumber' | 'ReceiptUSBirthCertificate' | 'ReceiptNativeAmericanTribalDoc' | 'ReceiptUSCitizenIDCardI197' | 'ReceiptIDCardForResidentCitizenI179' | 'ReceiptEmploymentAuthorizationDocumentDHS' | 'CertificationOfBirthDS1350FS545FS240' | 'ReceiptCertificationOfBirthAbroadFS545' | 'ReceiptCertificateOfReportOfBirthDS1350' | 'ReceiptConsularReportOfBirthAbroadFS240'
