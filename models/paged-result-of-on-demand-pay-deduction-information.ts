...
import { OnDemandPayDeductionInformation } from './on-demand-pay-deduction-information';
 ...
 * @export
 * @interface PagedResultOfOnDemandPayDeductionInformation
 */
export interface PagedResultOfOnDemandPayDeductionInformation {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfOnDemandPayDeductionInformation
     */
     ...
     * @memberof PagedResultOfOnDemandPayDeductionInformation
     */
    'AdditionalResultsUrl'?: string | null;
    /**
     * List of the API response records. 
     * @type {Array<OnDemandPayDeductionInformation>}
     * @memberof PagedResultOfOnDemandPayDeductionInformation
     */
    'Records'?: Array<OnDemandPayDeductionInformation> | null;
}
