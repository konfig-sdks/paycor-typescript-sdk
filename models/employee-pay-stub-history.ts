...
import { EmployeeDeductionsHistory } from './employee-deductions-history';
import { EmployeeEarningsHistory } from './employee-earnings-history';
import { EmployeeTaxesHistory } from './employee-taxes-history';
import { ResourceReference } from './resource-reference';

/**
 * 
 * @export
 * @interface EmployeePayStubHistory
 */
export interface EmployeePayStubHistory {
    /**
     * Unique identifier of the legal entity in Paycor\'s system.
     * @type {number}
     * @memberof EmployeePayStubHistory
     */
    ...
    /**
     * 
     * @type {EmployeeEarningsHistory}
     * @memberof EmployeePayStubHistory
     */
    'Earnings'?: EmployeeEarningsHistory;
    /**
     * 
     * @type {EmployeeDeductionsHistory}
     * @memberof EmployeePayStubHistory
     */
    'Deductions'?: EmployeeDeductionsHistory;
    /**
     * 
     * @type {EmployeeTaxesHistory}
     * @memberof EmployeePayStubHistory
     */
