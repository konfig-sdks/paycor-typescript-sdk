 ...
 * 
 * @export
 * @interface EmployeeTaxHistoryItem
 */
export interface EmployeeTaxHistoryItem {
    /**
     * Unique identifier of this tax item.
     * @type {string}
     * @memberof EmployeeTaxHistoryItem
     */
    'Id'?: string;
    /**
     ...
     * @memberof EmployeeTaxHistoryItem
     */
    'TaxableExemptWages'?: number | null;
    /**
     * Employee\'s taxable excess wage.
     * @type {number}
     * @memberof EmployeeTaxHistoryItem
     */
    'TaxableExcessWages'?: number | null;
    /**
