 ...
 * @export
 * @interface PagedResultOfEmployeeEarning
 */
export interface PagedResultOfEmployeeEarning {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeEarning
     */
     ...
     * @type {Array<EmployeeEarning>}
     * @memberof PagedResultOfEmployeeEarning
     */
    'Records'?: Array<EmployeeEarning> | null;
}
