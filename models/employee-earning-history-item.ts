 ...
 * 
 * @export
 * @interface EmployeeEarningHistoryItem
 */
export interface EmployeeEarningHistoryItem {
    /**
     * Unique identifier of this tax item.
     * @type {string}
     * @memberof EmployeeEarningHistoryItem
     */
    'Id'?: string;
    /**
     ...
     * @memberof EmployeeEarningHistoryItem
     */
    'TotalEarningAmount'?: number | null;
    /**
     * Total earning hours.
     * @type {number}
     * @memberof EmployeeEarningHistoryItem
     */
    'TotalEarningHours'?: number | null;
    /**
     ...
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningsTaxableAmount'?: number | null;
    /**
     * Taxable wages of this earning item.
     * @type {number}
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningsTaxableWages'?: number | null;
    /**
     * Exempt wages of this earning item.
     * @type {number}
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningsExemptWages'?: number | null;
    /**
     * Excess wages of this earning item.
     * @type {number}
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningsExcessWages'?: number | null;
    /**
     ...
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningTotalNonMemoAmount'?: number | null;
    /**
     * Total non memo hours of this earning item.
     * @type {number}
     * @memberof EmployeeEarningHistoryItem
     */
    'EarningTotalNonMemoHours'?: number | null;
    /**
