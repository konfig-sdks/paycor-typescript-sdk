 ...
 * @export
 * @interface EmployeeShortfallConfiguration
 */
export interface EmployeeShortfallConfiguration {
    /**
     * Unique identifier of the employee in Paycor\'s system. Generated by Paycor.
     * @type {string}
     * @memberof EmployeeShortfallConfiguration
     */
    'EmployeeId': string;
    /**
     * Date range filter.
     ...
     * @memberof EmployeeShortfallConfiguration
     */
    'ShortFallAlarmOption'?: string | null;
    /**
     * List of earnings codes.
     * @type {Array<string>}
     * @memberof EmployeeShortfallConfiguration
     */
    'EarningCodes'?: Array<string> | null;
    /**
