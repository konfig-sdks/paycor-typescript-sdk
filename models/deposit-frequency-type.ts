 ...
 * @enum {string}
 */
export type DepositFrequencyType = 'General' | 'Accelerated' | 'SemiWeekly' | 'BiWeekly' | 'Weekly' | 'EighthMonthly' | 'QuarterMonthly' | 'SemiMonthly' | 'Monthly20th' | 'Monthly' | 'Quarterly' | 'SemiAnnually' | 'Yearly' | 'ThreeDayFiler' | 'FiveDayFiler'
