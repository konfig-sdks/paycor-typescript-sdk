 ...
 * @enum {string}
 */
export type ListADocument = 'USPassport' | 'ForeignPassportWithI551stamp' | 'PermanentResidentOrAlienRegistrationI551' | 'EmploymentAuthorisationDocI766' | 'ForeignPassportAndI94orI94A' | 'PassportFromFSMorRMI' | 'DocsFromFSMorRMI' | 'I94withTempI551orRefugeeAdmissionStamp' | 'ForeignPassportorI94orI94AOR120orDS2019' | 'ReceiptReplacementPermanentResidentCardFormI551' | 'ReceiptReplacementEADFormI766' | 'ReceiptForeignPassportorI94or120orDS2019' | 'ReceiptFSMPassportWithFormI94orI94orI94A' | 'ReceiptRMIPassportWithFormI94orI94orI94A' | 'ReceiptUSPassportOrUSPassportCard' | 'ReceiptI94PermanentResidentCardI551StampAndPhoto' | 'ReceiptI94withRENotationOrRefugeeStamp'
