...
import { TenantCertificationOrganization } from './tenant-certification-organization';
 ...
 * @export
 * @interface PagedResultOfTenantCertificationOrganization
 */
export interface PagedResultOfTenantCertificationOrganization {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTenantCertificationOrganization
     */
     ...
     * @type {Array<TenantCertificationOrganization>}
     * @memberof PagedResultOfTenantCertificationOrganization
     */
    'Records'?: Array<TenantCertificationOrganization> | null;
}
