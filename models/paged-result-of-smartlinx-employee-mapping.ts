...
import { SmartlinxEmployeeMapping } from './smartlinx-employee-mapping';
 ...
 * @export
 * @interface PagedResultOfSmartlinxEmployeeMapping
 */
export interface PagedResultOfSmartlinxEmployeeMapping {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfSmartlinxEmployeeMapping
     */
     ...
     * @type {Array<SmartlinxEmployeeMapping>}
     * @memberof PagedResultOfSmartlinxEmployeeMapping
     */
    'Records'?: Array<SmartlinxEmployeeMapping> | null;
}
