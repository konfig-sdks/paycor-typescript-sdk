...
import { PayStub2 } from './pay-stub2';
 ...
 * @export
 * @interface PagedResultOfPayStub2
 */
export interface PagedResultOfPayStub2 {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfPayStub2
     */
