...
import { EmployeePayRate } from './employee-pay-rate';
 ...
 * @export
 * @interface PagedResultOfEmployeePayRate
 */
export interface PagedResultOfEmployeePayRate {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeePayRate
     */
     ...
     * @type {Array<EmployeePayRate>}
     * @memberof PagedResultOfEmployeePayRate
     */
    'Records'?: Array<EmployeePayRate> | null;
}
