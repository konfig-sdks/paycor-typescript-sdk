 ...
 * @enum {string}
 */
export type ListBDocument = 'DriverLicenseorIDcard' | 'FederalORstateORLocalGovtID' | 'SchoolIDcardWithPhotograph' | 'VotersRegistrationCard' | 'USMilitaryCardOrDraftRecord' | 'MilitaryDependentsIDcard' | 'USCoastGuardMerchantMariner' | 'NativeAmericanTribalDoc' | 'DriverLicenseCanadianGovt' | 'SchoolRecordOrReportCard' | 'ClinicDoctorOrHospitalRecord' | 'DaycareOrNurserySchoolRecord' | 'DriverLicense' | 'IDCardIssuedByUSStateOrOutlyingPossession' | 'ReceiptDriverLicenseOrIDCard' | 'ReceiptFederalOrStateOrLocalGovtID' | 'ReceiptSchoolIDCardWithPhotograph' | 'ReceiptVotersRegistrationCard' | 'ReceiptUSMilitaryCardOrDraftRecord' | 'ReceiptMilitaryDependentsIDCard' | 'ReceiptUSCoastGuardMerchantMariner' | 'ReceiptNativeAmericanTribalDoc' | 'ReceiptDriverLicenseCanadianGovt' | 'ReceiptSchoolRecordOrReportCard' | 'ReceiptClinicDoctorOrHospitalRecord' | 'ReceiptDayCareOrNurserySchoolRecord' | 'ReceiptDriversLicense' | 'ReceiptUSStateCardOrOutlyingPossession'
