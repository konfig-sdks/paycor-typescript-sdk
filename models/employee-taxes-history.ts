...
import { EmployeeTaxHistoryItem } from './employee-tax-history-item';

/**
 * 
 * @export
 * @interface EmployeeTaxesHistory
 */
export interface EmployeeTaxesHistory {
    /**
     * Sum of all employee tax amounts in TaxHistoryItems collection.
     * @type {number}
     * @memberof EmployeeTaxesHistory
     */
    'TotalEmployeeAmount'?: number | null;
    /**
     * Sum of all employer tax amounts in TaxHistoryItems collection.
     * @type {number}
     * @memberof EmployeeTaxesHistory
     */
    'TotalEmployerAmount'?: number | null;
    /**
     * List of Taxes.
     * @type {Array<EmployeeTaxHistoryItem>}
     * @memberof EmployeeTaxesHistory
     */
    'TaxHistoryItems'?: Array<EmployeeTaxHistoryItem> | null;
}
