 ...
 * 
 * @export
 * @interface EmployeeDeductionHistoryItem
 */
export interface EmployeeDeductionHistoryItem {
    /**
     * Unique identifier of this deduction item.
     * @type {string}
     * @memberof EmployeeDeductionHistoryItem
     */
    'Id'?: string;
    /**
     ...
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionTotalNonMemoHours'?: number | null;
    /**
     * Taxable amount of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionTaxableAmount'?: number | null;
    /**
     * Taxable wages of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionTaxableWages'?: number | null;
    /**
     * Exempt wages of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionExemptWages'?: number | null;
    /**
     * Excess wages of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionExcessWages'?: number | null;
    /**
     * Total wages of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionTotalWages'?: number | null;
    /**
     * Total non memo amount of this deduction item.
     * @type {number}
     * @memberof EmployeeDeductionHistoryItem
     */
    'DeductionTotalNonMemoAmount'?: number | null;
    /**
