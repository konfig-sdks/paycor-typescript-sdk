 ...
 * @export
 * @interface PagedResultOfEmployeeDeduction
 */
export interface PagedResultOfEmployeeDeduction {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeDeduction
     */
     ...
     * @type {Array<EmployeeDeduction>}
     * @memberof PagedResultOfEmployeeDeduction
     */
    'Records'?: Array<EmployeeDeduction> | null;
}
