...
import { EmployeeDirectDeposit } from './employee-direct-deposit';
 ...
 * @export
 * @interface PagedResultOfEmployeeDirectDeposit
 */
export interface PagedResultOfEmployeeDirectDeposit {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeDirectDeposit
     */
     ...
     * @type {Array<EmployeeDirectDeposit>}
     * @memberof PagedResultOfEmployeeDirectDeposit
     */
    'Records'?: Array<EmployeeDirectDeposit> | null;
}
