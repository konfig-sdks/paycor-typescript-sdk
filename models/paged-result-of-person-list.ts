 ...
 * @export
 * @interface PagedResultOfPersonList
 */
export interface PagedResultOfPersonList {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfPersonList
     */
     ...
     * @type {Array<PersonList>}
     * @memberof PagedResultOfPersonList
     */
    'Records'?: Array<PersonList> | null;
}
