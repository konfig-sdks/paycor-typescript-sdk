...
import { EmploymentStatusIdentifyingData } from './employment-status-identifying-data';

/**
 * 
 * @export
 * @interface EmployeesIdentifyingData
 */
export interface EmployeesIdentifyingData {
    /**
     * First name of the employee.
     * @type {string}
     * @memberof EmployeesIdentifyingData
     */
     ...
     * @type {EmploymentStatusIdentifyingData}
     * @memberof EmployeesIdentifyingData
     */
