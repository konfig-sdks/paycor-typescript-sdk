 ...
 * 
 * @export
 * @interface TenantCertificationOrganization
 */
export interface TenantCertificationOrganization {
    /**
     * Identifier of certification organization.             
     * @type {string}
     * @memberof TenantCertificationOrganization
     */
    'CertificationOrganizationId'?: string;
    /**
     * Name of the organization that is issuing the certification.             
     * @type {string}
     * @memberof TenantCertificationOrganization
     */
    'CertificationOrganizationName'?: string | null;
}
