...
import { LegalEntityDeduction } from './legal-entity-deduction';
 ...
 * @export
 * @interface PagedResultOfLegalEntityDeduction
 */
export interface PagedResultOfLegalEntityDeduction {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfLegalEntityDeduction
     */
     ...
     * @type {Array<LegalEntityDeduction>}
     * @memberof PagedResultOfLegalEntityDeduction
     */
    'Records'?: Array<LegalEntityDeduction> | null;
}
