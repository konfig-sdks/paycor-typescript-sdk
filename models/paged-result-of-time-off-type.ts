 ...
 * @export
 * @interface PagedResultOfTimeOffType
 */
export interface PagedResultOfTimeOffType {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTimeOffType
     */
     ...
     * @type {Array<TimeOffType>}
     * @memberof PagedResultOfTimeOffType
     */
    'Records'?: Array<TimeOffType> | null;
}
