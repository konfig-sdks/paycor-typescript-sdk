...
import { PayStubTaxItem2 } from './pay-stub-tax-item2';

/**
 * 
 * @export
 * @interface PayStubTax2
 */
export interface PayStubTax2 {
    /**
     * Sum of all tax amounts in Taxes collection
     * @type {number}
     * @memberof PayStubTax2
     */
     ...
     * @memberof PayStubTax2
     */
    'TotalEmployeeTaxAmount'?: number | null;
    /**
     * Sum of all tax amounts in Deductions collection for employers
     * @type {number}
     * @memberof PayStubTax2
     */
    'TotalEmployerTaxAmount'?: number | null;
    /**
     * List of Taxes included on the paycheck
     * @type {Array<PayStubTaxItem2>}
     * @memberof PayStubTax2
     */
    'Taxes'?: Array<PayStubTaxItem2> | null;
}
