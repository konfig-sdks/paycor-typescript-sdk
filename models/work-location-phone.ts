...
import { WorkLocationPhoneAllOf } from './work-location-phone-all-of';
import { WorkLocationPhoneType } from './work-location-phone-type';

/**
 * @type WorkLocationPhone
 * @export
 */
export type WorkLocationPhone = Phone & WorkLocationPhoneAllOf;
