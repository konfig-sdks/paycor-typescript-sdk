...
import { LaborCategories } from './labor-categories';
 ...
 * @export
 * @interface PagedResultOfLaborCategories
 */
export interface PagedResultOfLaborCategories {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfLaborCategories
     */
     ...
     * @type {Array<LaborCategories>}
     * @memberof PagedResultOfLaborCategories
     */
    'Records'?: Array<LaborCategories> | null;
}
