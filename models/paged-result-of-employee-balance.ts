...
import { EmployeeBalance } from './employee-balance';
 ...
 * @export
 * @interface PagedResultOfEmployeeBalance
 */
export interface PagedResultOfEmployeeBalance {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeBalance
     */
     ...
     * @type {Array<EmployeeBalance>}
     * @memberof PagedResultOfEmployeeBalance
     */
    'Records'?: Array<EmployeeBalance> | null;
}
