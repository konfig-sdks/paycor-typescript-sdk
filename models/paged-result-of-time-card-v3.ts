...
import { TimeCardV3 } from './time-card-v3';
 ...
 * @export
 * @interface PagedResultOfTimeCardV3
 */
export interface PagedResultOfTimeCardV3 {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTimeCardV3
     */
     ...
     * @type {Array<TimeCardV3>}
     * @memberof PagedResultOfTimeCardV3
     */
    'Records'?: Array<TimeCardV3> | null;
}
