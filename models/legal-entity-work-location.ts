...
import { LegalEntityWorkLocationAddress } from './legal-entity-work-location-address';
import { WorkLocationPhone } from './work-location-phone';

/**
 * 
 * @export
 * @interface LegalEntityWorkLocation
 */
export interface LegalEntityWorkLocation {
    /**
     * Unique identifier of the legal entity\'s work location in Paycor\'s system. Generated by Paycor.
     * @type {string}
     * @memberof LegalEntityWorkLocation
     */
    'Id'?: string;
    /**
     ...
     * @type {Array<LegalEntityWorkLocationAddress>}
     * @memberof LegalEntityWorkLocation
     */
    'Addresses'?: Array<LegalEntityWorkLocationAddress> | null;
    /**
     * A list of the legal entity\'s work location\'s phone numbers.             
     * @type {Array<WorkLocationPhone>}
     * @memberof LegalEntityWorkLocation
     */
    'Phones'?: Array<WorkLocationPhone> | null;
    /**
