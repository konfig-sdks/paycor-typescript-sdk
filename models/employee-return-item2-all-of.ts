 ...
 * 
 * @export
 * @interface EmployeeReturnItem2AllOf
 */
export interface EmployeeReturnItem2AllOf {
    /**
     * 
     * @type {WorkEmailExample2}
     * @memberof EmployeeReturnItem2AllOf
     */
    'Email'?: WorkEmailExample2;
}
