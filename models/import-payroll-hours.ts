...
export interface ImportPayrollHours {
     ...
     * @type {Array<ImportEmployee>}
     * @memberof ImportPayrollHours
     */
    'ImportEmployees': Array<ImportEmployee>;
}
