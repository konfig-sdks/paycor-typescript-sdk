 ...
 * @export
 * @interface PagedResultOfJobCosting
 */
export interface PagedResultOfJobCosting {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfJobCosting
     */
     ...
     * @type {Array<JobCosting>}
     * @memberof PagedResultOfJobCosting
     */
    'Records'?: Array<JobCosting> | null;
}
