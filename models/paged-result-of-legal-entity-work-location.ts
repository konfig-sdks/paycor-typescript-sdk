...
import { LegalEntityWorkLocation } from './legal-entity-work-location';
 ...
 * @export
 * @interface PagedResultOfLegalEntityWorkLocation
 */
export interface PagedResultOfLegalEntityWorkLocation {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfLegalEntityWorkLocation
     */
     ...
     * @type {Array<LegalEntityWorkLocation>}
     * @memberof PagedResultOfLegalEntityWorkLocation
     */
    'Records'?: Array<LegalEntityWorkLocation> | null;
}
