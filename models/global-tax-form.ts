 ...
 * @export
 * @interface GlobalTaxForm
 */
export interface GlobalTaxForm {
    /**
     * Effective start date of withholding.
     * @type {string}
     * @memberof GlobalTaxForm
     */
