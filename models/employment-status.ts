 ...
 * @enum {string}
 */
export type EmploymentStatus = 'Active' | 'Deceased' | 'LongTermDisability' | 'ShortTermDisability' | 'Fmla' | 'LaidOff' | 'LeaveWithPay' | 'LeaveWithoutPay' | 'ThirdPartyPayable' | 'Resigned' | 'Retired' | 'Terminated' | 'WorkersCompensation'
