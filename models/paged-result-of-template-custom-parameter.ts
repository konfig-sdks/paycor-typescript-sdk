...
import { TemplateCustomParameter } from './template-custom-parameter';
 ...
 * @export
 * @interface PagedResultOfTemplateCustomParameter
 */
export interface PagedResultOfTemplateCustomParameter {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTemplateCustomParameter
     */
     ...
     * @type {Array<TemplateCustomParameter>}
     * @memberof PagedResultOfTemplateCustomParameter
     */
    'Records'?: Array<TemplateCustomParameter> | null;
}
