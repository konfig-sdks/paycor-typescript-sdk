...
import { LegalEntityPayData } from './legal-entity-pay-data';
 ...
 * @export
 * @interface PagedResultOfLegalEntityPayData
 */
export interface PagedResultOfLegalEntityPayData {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfLegalEntityPayData
     */
     ...
     * @type {Array<LegalEntityPayData>}
     * @memberof PagedResultOfLegalEntityPayData
     */
    'Records'?: Array<LegalEntityPayData> | null;
}
