...
import { EmploymentStatus2 } from './employment-status2';
 ...
 * @export
 * @interface EmployeePositionAndStatus
 */
export interface EmployeePositionAndStatus {
    /**
     * Enumeration of valid Employment Status Update values.             
     * @type {EmploymentStatus2}
     * @memberof EmployeePositionAndStatus
     */
