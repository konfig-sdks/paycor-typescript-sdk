...
import { PayStubEarningItem2 } from './pay-stub-earning-item2';

/**
 * 
 * @export
 * @interface PayStubEarning2
 */
export interface PayStubEarning2 {
    /**
     * Sum of all earning amounts in Earnings collection
     * @type {number}
     * @memberof PayStubEarning2
     */
    'TotalEarningsAmount'?: number | null;
    /**
     * Sum of all earning hours in Earnings collection
     * @type {number}
     * @memberof PayStubEarning2
     */
    'TotalEarningsHours'?: number | null;
    /**
     * List of Earnings included 
     * @type {Array<PayStubEarningItem2>}
     * @memberof PayStubEarning2
     */
    'Earnings'?: Array<PayStubEarningItem2> | null;
}
