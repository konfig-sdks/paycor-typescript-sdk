...
import { TimeCardv2 } from './time-cardv2';
 ...
 * @export
 * @interface PagedResultOfTimeCardv2
 */
export interface PagedResultOfTimeCardv2 {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTimeCardv2
     */
     ...
     * @type {Array<TimeCardv2>}
     * @memberof PagedResultOfTimeCardv2
     */
    'Records'?: Array<TimeCardv2> | null;
}
