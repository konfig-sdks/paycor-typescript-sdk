...
import { EmployeeDeductionAmount2 } from './employee-deduction-amount2';
import { IncludeInPay } from './include-in-pay';
import { PayFrequency } from './pay-frequency';

/**
 * The employee deduction create model
 * @export
 * @interface EmployeeDeduction2
 */
export interface EmployeeDeduction2 {
    /**
     * Unique deduction code set at the legal entity or tenant level.  
     * @type {string}
     * @memberof EmployeeDeduction2
     */
    'Code': string;
    /**
     ...
     * @type {Array<EmployeeDeductionAmount2>}
     * @memberof EmployeeDeduction2
     */
    'AmountData'?: Array<EmployeeDeductionAmount2> | null;
}
