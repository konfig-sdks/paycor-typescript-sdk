...
import { EmploymentStatus3 } from './employment-status3';
 ...
 * @export
 * @interface EmployeeStatusData2
 */
export interface EmployeeStatusData2 {
    /**
     * Whether employee is full time.              
     * @type {boolean}
     * @memberof EmployeeStatusData2
     */
    'IsFullTime'?: boolean | null;
    /**
     * Enumeration of valid Employment Status values.             
     * @type {EmploymentStatus3}
     * @memberof EmployeeStatusData2
     */
