...
import { EmployeePayStubHistory } from './employee-pay-stub-history';
 ...
 * @export
 * @interface PagedResultOfEmployeePayStubHistory
 */
export interface PagedResultOfEmployeePayStubHistory {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeePayStubHistory
     */
     ...
     * @type {Array<EmployeePayStubHistory>}
     * @memberof PagedResultOfEmployeePayStubHistory
     */
    'Records'?: Array<EmployeePayStubHistory> | null;
}
