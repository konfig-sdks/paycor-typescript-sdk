...
import { TenantWorkLocation } from './tenant-work-location';
 ...
 * @export
 * @interface PagedResultOfTenantWorkLocation
 */
export interface PagedResultOfTenantWorkLocation {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTenantWorkLocation
     */
     ...
     * @type {Array<TenantWorkLocation>}
     * @memberof PagedResultOfTenantWorkLocation
     */
    'Records'?: Array<TenantWorkLocation> | null;
}
