...
import { WorkLocationAddressType2 } from './work-location-address-type2';

/**
 * The Legal Entity Work Location Address model represents Legal Entity Work Location Address information.
 * @export
 * @interface LegalEntityWorkLocationAddress
 */
export interface LegalEntityWorkLocationAddress {
    /**
     * First line of street address information.             
     * @type {string}
     * @memberof LegalEntityWorkLocationAddress
     */
