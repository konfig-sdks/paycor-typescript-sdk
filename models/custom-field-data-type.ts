 ...
 * @enum {string}
 */
export type CustomFieldDataType = 'FreeFormAlphaNumeric' | 'FreeFormCurrency' | 'DropDownAlphaNumeric' | 'DropDownYesNo' | 'DropDownCurrency' | 'Date' | 'PickListAlphaNumeric' | 'PickListCurrency'
