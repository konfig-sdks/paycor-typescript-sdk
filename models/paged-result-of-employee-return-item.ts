...
import { EmployeeReturnItem2 } from './employee-return-item2';
 ...
 * @export
 * @interface PagedResultOfEmployeeReturnItem
 */
export interface PagedResultOfEmployeeReturnItem {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeReturnItem
     */
     ...
     * @type {Array<EmployeeReturnItem2>}
     * @memberof PagedResultOfEmployeeReturnItem
     */
    'Records'?: Array<EmployeeReturnItem2> | null;
}
