...
import { EmployeeEmailType } from './employee-email-type';
import { WorkEmailExampleAllOf } from './work-email-example-all-of';

/**
 * @type WorkEmailExample2
 * @export
 */
export type WorkEmailExample2 = Email & WorkEmailExampleAllOf;
