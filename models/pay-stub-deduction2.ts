...
import { PayStubDeductionItem2 } from './pay-stub-deduction-item2';

/**
 * 
 * @export
 * @interface PayStubDeduction2
 */
export interface PayStubDeduction2 {
    /**
     * Sum of all deduction amounts in Deductions collection
     * @type {number}
     * @memberof PayStubDeduction2
     */
     ...
     * @memberof PayStubDeduction2
     */
    'TotalEmployerDeductionsAmount'?: number | null;
    /**
     * Sum of all deduction amounts in Deductions collection for employees
     * @type {number}
     * @memberof PayStubDeduction2
     */
    'TotalEmployeeDeductionsAmount'?: number | null;
    /**
     * List of Deductions included 
     * @type {Array<PayStubDeductionItem2>}
     * @memberof PayStubDeduction2
     */
    'Deductions'?: Array<PayStubDeductionItem2> | null;
}
