...
import { EmployeeTimeOffRequest } from './employee-time-off-request';
 ...
 * @export
 * @interface PagedResultOfEmployeeTimeOffRequest
 */
export interface PagedResultOfEmployeeTimeOffRequest {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeTimeOffRequest
     */
     ...
     * @type {Array<EmployeeTimeOffRequest>}
     * @memberof PagedResultOfEmployeeTimeOffRequest
     */
    'Records'?: Array<EmployeeTimeOffRequest> | null;
}
