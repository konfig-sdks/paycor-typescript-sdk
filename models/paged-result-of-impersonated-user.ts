 ...
 * @export
 * @interface PagedResultOfImpersonatedUser
 */
export interface PagedResultOfImpersonatedUser {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfImpersonatedUser
     */
     ...
     * @type {Array<ImpersonatedUser>}
     * @memberof PagedResultOfImpersonatedUser
     */
    'Records'?: Array<ImpersonatedUser> | null;
}
