 ...
 * @enum {string}
 */
export type EmploymentStatus3 = 'Active' | 'Deceased' | 'LongTermDisability' | 'ShortTermDisability' | 'Fmla' | 'LaidOff' | 'LeaveWithPay' | 'LeaveWithoutPay' | 'ThirdPartyPayable' | 'Resigned' | 'Retired' | 'Terminated' | 'WorkersCompensation'
