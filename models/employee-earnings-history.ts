...
import { EmployeeEarningHistoryItem } from './employee-earning-history-item';

/**
 * 
 * @export
 * @interface EmployeeEarningsHistory
 */
export interface EmployeeEarningsHistory {
    /**
     * Sum of all earning amounts in EarningHistoryItems collection.
     * @type {number}
     * @memberof EmployeeEarningsHistory
     */
    'TotalEarningsAmount'?: number | null;
    /**
     * List of Earnings.
     * @type {Array<EmployeeEarningHistoryItem>}
     * @memberof EmployeeEarningsHistory
     */
    'EarningHistoryItems'?: Array<EmployeeEarningHistoryItem> | null;
}
