 ...
 * @export
 * @interface PagedResultOfReportBuilder
 */
export interface PagedResultOfReportBuilder {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfReportBuilder
     */
     ...
     * @type {Array<ReportBuilder>}
     * @memberof PagedResultOfReportBuilder
     */
    'Records'?: Array<ReportBuilder> | null;
}
