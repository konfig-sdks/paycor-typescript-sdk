...
import { PayStubFile } from './pay-stub-file';
 ...
 * @export
 * @interface PagedResultOfPayStubFile
 */
export interface PagedResultOfPayStubFile {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfPayStubFile
     */
     ...
     * @type {Array<PayStubFile>}
     * @memberof PagedResultOfPayStubFile
     */
    'Records'?: Array<PayStubFile> | null;
}
