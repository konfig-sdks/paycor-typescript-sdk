 ...
 * @export
 * @interface PagedResultOfEmployeeSchedule
 */
export interface PagedResultOfEmployeeSchedule {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfEmployeeSchedule
     */
     ...
     * @type {Array<EmployeeSchedule>}
     * @memberof PagedResultOfEmployeeSchedule
     */
    'Records'?: Array<EmployeeSchedule> | null;
}
