...
import { TenantJobTitle } from './tenant-job-title';
 ...
 * @export
 * @interface PagedResultOfTenantJobTitle
 */
export interface PagedResultOfTenantJobTitle {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfTenantJobTitle
     */
     ...
     * @type {Array<TenantJobTitle>}
     * @memberof PagedResultOfTenantJobTitle
     */
    'Records'?: Array<TenantJobTitle> | null;
}
