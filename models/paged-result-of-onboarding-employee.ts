 ...
 * @export
 * @interface PagedResultOfOnboardingEmployee
 */
export interface PagedResultOfOnboardingEmployee {
    /**
     * Whether additional API result records exist on the Paycor system.
     * @type {boolean}
     * @memberof PagedResultOfOnboardingEmployee
     */
     ...
     * @type {Array<OnboardingEmployee>}
     * @memberof PagedResultOfOnboardingEmployee
     */
    'Records'?: Array<OnboardingEmployee> | null;
}
