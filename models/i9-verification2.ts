...
import { ListC } from './list-c';
import { WorkEligibility } from './work-eligibility';

/**
 * 
 * @export
 * @interface I9Verification2
 */
export interface I9Verification2 {
    /**
     * Country of which the employee is citizen of.             
     * @type {string}
     * @memberof I9Verification2
     */
    'CitizenOfCountry'?: string | null;
    /**
     ...
     * @memberof I9Verification2
     */
    'WorkVisaExpirationDate'?: string | null;
    /**
     * Alien admission number of the employee.             
     * @type {string}
     * @memberof I9Verification2
     */
    'AlienAdmissionNumber'?: string | null;
    /**
     * Expiration date of the alien admission.             
     * @type {string}
     * @memberof I9Verification2
     */
    'AlienAdmissionExpirationDate'?: string | null;
    /**
     * 
     * @type {ListA}
     * @memberof I9Verification2
