...
import { WorkLocationAddressUpdate } from './work-location-address-update';
import { WorkLocationPhoneNumber } from './work-location-phone-number';

/**
 * 
 * @export
 * @interface WorkLocation2
 */
export interface WorkLocation2 {
    /**
     * Unique identifier of the work location in Paycor\'s system. Generated by Paycor.
     * @type {string}
     * @memberof WorkLocation2
     */
    'Id': string;
    /**
     * A list of work location\'s addresses.
     * @type {Array<WorkLocationAddressUpdate>}
     * @memberof WorkLocation2
     */
    'Addresses'?: Array<WorkLocationAddressUpdate> | null;
    /**
     * A list of the work location\'s phone numbers.             
     * @type {Array<WorkLocationPhoneNumber>}
     * @memberof WorkLocation2
     */
    'PhoneNumbers'?: Array<WorkLocationPhoneNumber> | null;
    /**
     * Time zone.             
     * @type {string}
     * @memberof WorkLocation2
