...
/**
 * LegalEntityServicesApi - axios parameter creator
 * @export
 */
export const LegalEntityServicesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: View Legal Entity Services
         * @summary Get subscribed services for Legal Entity
         * @param {number} legalEntityId ID of the Legal Entity you want to get (synonymous to Paycor\&#39;s ClientID)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getSubscribedServices: async (legalEntityId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalEntityId' is not null or undefined
            assertParamExists('getSubscribedServices', 'legalEntityId', legalEntityId)
            const localVarPath = `/v1/legalentities/{legalEntityId}/services`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/services',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityServicesApi - functional programming interface
 * @export
 */
export const LegalEntityServicesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityServicesApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Legal Entity Services
         * @summary Get subscribed services for Legal Entity
         * @param {LegalEntityServicesApiGetSubscribedServicesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getSubscribedServices(requestParameters: LegalEntityServicesApiGetSubscribedServicesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Services>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getSubscribedServices(requestParameters.legalEntityId, options);
...
/**
 * LegalEntityServicesApi - factory interface
 * @export
 */
export const LegalEntityServicesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityServicesApiFp(configuration)
    return {
        /**
         * Data Access: View Legal Entity Services
         * @summary Get subscribed services for Legal Entity
         ...
         * @throws {RequiredError}
         */
        getSubscribedServices(requestParameters: LegalEntityServicesApiGetSubscribedServicesRequest, options?: AxiosRequestConfig): AxiosPromise<Services> {
            return localVarFp.getSubscribedServices(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getSubscribedServices operation in LegalEntityServicesApi.
 * @export
 * @interface LegalEntityServicesApiGetSubscribedServicesRequest
 */
export type LegalEntityServicesApiGetSubscribedServicesRequest = {
    
    /**
    * ID of the Legal Entity you want to get (synonymous to Paycor\'s ClientID)
    * @type {number}
    * @memberof LegalEntityServicesApiGetSubscribedServices
    */
...
/**
 * LegalEntityServicesApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityServicesApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityServicesApiGenerated extends BaseAPI {
    /**
     * Data Access: View Legal Entity Services
     * @summary Get subscribed services for Legal Entity
     * @param {LegalEntityServicesApiGetSubscribedServicesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityServicesApiGenerated
     */
    public getSubscribedServices(requestParameters: LegalEntityServicesApiGetSubscribedServicesRequest, options?: AxiosRequestConfig) {
        return LegalEntityServicesApiFp(this.configuration).getSubscribedServices(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
