...
// @ts-ignore
import { LegalEntityEarning } from '../models';
// @ts-ignore
...
/**
 * LegalEntityEarningsApi - axios parameter creator
 * @export
 */
export const LegalEntityEarningsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
        ...
        getByLegalEntityId: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/legalentities/{legalEntityId}/earnings`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/earnings',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityEarningsApi - functional programming interface
 * @export
 */
export const LegalEntityEarningsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityEarningsApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {LegalEntityEarningsApiGetByLegalEntityIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByLegalEntityId(requestParameters: LegalEntityEarningsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<LegalEntityEarning>>> {
...
/**
 * LegalEntityEarningsApi - factory interface
 * @export
 */
export const LegalEntityEarningsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityEarningsApiFp(configuration)
    return {
        /**
         * 
         * @param {LegalEntityEarningsApiGetByLegalEntityIdRequest} requestParameters Request parameters.
         ...
         * @throws {RequiredError}
         */
        getByLegalEntityId(requestParameters: LegalEntityEarningsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): AxiosPromise<Array<LegalEntityEarning>> {
...
/**
 * Request parameters for getByLegalEntityId operation in LegalEntityEarningsApi.
 * @export
 * @interface LegalEntityEarningsApiGetByLegalEntityIdRequest
 */
export type LegalEntityEarningsApiGetByLegalEntityIdRequest = {
    
    /**
    * 
    * @type {number}
    * @memberof LegalEntityEarningsApiGetByLegalEntityId
    */
...
/**
 * LegalEntityEarningsApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityEarningsApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityEarningsApiGenerated extends BaseAPI {
    /**
     * 
     * @param {LegalEntityEarningsApiGetByLegalEntityIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityEarningsApiGenerated
     */
    public getByLegalEntityId(requestParameters: LegalEntityEarningsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityEarningsApiFp(this.configuration).getByLegalEntityId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
