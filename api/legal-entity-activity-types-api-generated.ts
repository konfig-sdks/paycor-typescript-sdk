...
// @ts-ignore
import { PagedResultOfActivityType } from '../models';
// @ts-ignore
...
/**
 * LegalEntityActivityTypesApi - axios parameter creator
 * @export
 */
export const LegalEntityActivityTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Get Legal Entity Activity Types by Legal Entity ID
         * @param {number} legalEntityId Legal Entity Id for whom you want to get the Activity Types
        ...
        getByLegalEntityId: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/legalentities/{legalEntityId}/activitytypes`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/activitytypes',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityActivityTypesApi - functional programming interface
 * @export
 */
export const LegalEntityActivityTypesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityActivityTypesApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Get Legal Entity Activity Types by Legal Entity ID
         * @param {LegalEntityActivityTypesApiGetByLegalEntityIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByLegalEntityId(requestParameters: LegalEntityActivityTypesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfActivityType>> {
...
/**
 * LegalEntityActivityTypesApi - factory interface
 * @export
 */
export const LegalEntityActivityTypesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityActivityTypesApiFp(configuration)
    return {
        /**
         * 
         * @summary Get Legal Entity Activity Types by Legal Entity ID
         ...
         * @throws {RequiredError}
         */
        getByLegalEntityId(requestParameters: LegalEntityActivityTypesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfActivityType> {
...
/**
 * Request parameters for getByLegalEntityId operation in LegalEntityActivityTypesApi.
 * @export
 * @interface LegalEntityActivityTypesApiGetByLegalEntityIdRequest
 */
export type LegalEntityActivityTypesApiGetByLegalEntityIdRequest = {
    
    /**
    * Legal Entity Id for whom you want to get the Activity Types
    * @type {number}
    * @memberof LegalEntityActivityTypesApiGetByLegalEntityId
    */
...
/**
 * LegalEntityActivityTypesApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityActivityTypesApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityActivityTypesApiGenerated extends BaseAPI {
    /**
     * 
     * @summary Get Legal Entity Activity Types by Legal Entity ID
     * @param {LegalEntityActivityTypesApiGetByLegalEntityIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityActivityTypesApiGenerated
     */
    public getByLegalEntityId(requestParameters: LegalEntityActivityTypesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityActivityTypesApiFp(this.configuration).getByLegalEntityId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
