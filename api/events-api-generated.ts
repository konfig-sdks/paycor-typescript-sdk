...
export const EventsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Command} command Mock Event that user wants to trigger.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        notifyEventDetails: async (command: Command, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'command' is not null or undefined
            assertParamExists('notifyEventDetails', 'command', command)
            const localVarPath = `/v1/events/mockevent`;
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/events/mockevent',
                httpMethod: 'POST'
            });
...
export const EventsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Following body attributes are optionally required: * ItemId is required when EventType is Employee.Modified * LegalEntityId is required when EventType is LegalEntity.Modified
         * @summary Mock Event Notification
         * @param {EventsApiNotifyEventDetailsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async notifyEventDetails(requestParameters: EventsApiNotifyEventDetailsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Event>> {
            const command: Command = {
                ApplicationId: requestParameters.ApplicationId,
                NotificationURL: requestParameters.NotificationURL,
                NotificationSecret: requestParameters.NotificationSecret,
                EventType: requestParameters.EventType,
                ItemId: requestParameters.ItemId,
                LegalEntityId: requestParameters.LegalEntityId,
                TenantId: requestParameters.TenantId
            };
            const localVarAxiosArgs = await localVarAxiosParamCreator.notifyEventDetails(command, options);
...
export const EventsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        notifyEventDetails(requestParameters: EventsApiNotifyEventDetailsRequest, options?: AxiosRequestConfig): AxiosPromise<Event> {
            return localVarFp.notifyEventDetails(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for notifyEventDetails operation in EventsApi.
 * @export
 * @interface EventsApiNotifyEventDetailsRequest
 */
export type EventsApiNotifyEventDetailsRequest = {
...
export class EventsApiGenerated extends BaseAPI {
     ...
     */
    public notifyEventDetails(requestParameters: EventsApiNotifyEventDetailsRequest, options?: AxiosRequestConfig) {
        return EventsApiFp(this.configuration).notifyEventDetails(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
