...
// @ts-ignore
import { PagedResultOfTimeOffType } from '../models';
// @ts-ignore
...
/**
 * LegalEntityTimeOffTypesApi - axios parameter creator
 * @export
 */
export const LegalEntityTimeOffTypesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: View Time Off Types
         * @summary Get Legal Entity Time Off Types
         * @param {number} legalEntityId ID of an Legal Entity for which you want to get the Time Off Types
         * @param {string} [continuationToken] Token to get the next set of results
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        viewTimeOffTypes: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalEntityId' is not null or undefined
            assertParamExists('viewTimeOffTypes', 'legalEntityId', legalEntityId)
            const localVarPath = `/v1/legalentities/{legalEntityId}/timeofftypes`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/timeofftypes',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityTimeOffTypesApi - functional programming interface
 * @export
 */
export const LegalEntityTimeOffTypesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityTimeOffTypesApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Time Off Types
         * @summary Get Legal Entity Time Off Types
         * @param {LegalEntityTimeOffTypesApiViewTimeOffTypesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async viewTimeOffTypes(requestParameters: LegalEntityTimeOffTypesApiViewTimeOffTypesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfTimeOffType>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.viewTimeOffTypes(requestParameters.legalEntityId, requestParameters.continuationToken, options);
...
/**
 * LegalEntityTimeOffTypesApi - factory interface
 * @export
 */
export const LegalEntityTimeOffTypesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityTimeOffTypesApiFp(configuration)
    return {
        /**
         * Data Access: View Time Off Types
         * @summary Get Legal Entity Time Off Types
         ...
         * @throws {RequiredError}
         */
        viewTimeOffTypes(requestParameters: LegalEntityTimeOffTypesApiViewTimeOffTypesRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfTimeOffType> {
            return localVarFp.viewTimeOffTypes(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for viewTimeOffTypes operation in LegalEntityTimeOffTypesApi.
 * @export
 * @interface LegalEntityTimeOffTypesApiViewTimeOffTypesRequest
 */
export type LegalEntityTimeOffTypesApiViewTimeOffTypesRequest = {
    
    /**
    * ID of an Legal Entity for which you want to get the Time Off Types
    * @type {number}
    * @memberof LegalEntityTimeOffTypesApiViewTimeOffTypes
    */
...
/**
 * LegalEntityTimeOffTypesApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityTimeOffTypesApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityTimeOffTypesApiGenerated extends BaseAPI {
    /**
     * Data Access: View Time Off Types
     * @summary Get Legal Entity Time Off Types
     * @param {LegalEntityTimeOffTypesApiViewTimeOffTypesRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityTimeOffTypesApiGenerated
     */
    public viewTimeOffTypes(requestParameters: LegalEntityTimeOffTypesApiViewTimeOffTypesRequest, options?: AxiosRequestConfig) {
        return LegalEntityTimeOffTypesApiFp(this.configuration).viewTimeOffTypes(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
