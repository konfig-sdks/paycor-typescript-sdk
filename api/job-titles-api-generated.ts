...
export const JobTitlesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} tenantId ID of the Tenant you want to get Job Titles.
        ...
        listByTenantId: async (tenantId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/tenants/{tenantId}/jobtitles`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/tenants/{tenantId}/jobtitles',
                httpMethod: 'GET'
            });
...
export const JobTitlesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Job Titles are configured at a Tenant level, unlike most other objects which are configured at a Legal Entity level.  Data Access: View Tenant Job Titles
         * @summary Get All Job Titles by Tenant ID
         * @param {JobTitlesApiListByTenantIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listByTenantId(requestParameters: JobTitlesApiListByTenantIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfTenantJobTitle>> {
...
export const JobTitlesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listByTenantId(requestParameters: JobTitlesApiListByTenantIdRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfTenantJobTitle> {
...
/**
 * Request parameters for listByTenantId operation in JobTitlesApi.
 * @export
 * @interface JobTitlesApiListByTenantIdRequest
 */
export type JobTitlesApiListByTenantIdRequest = {
    
    /**
    * ID of the Tenant you want to get Job Titles.
    * @type {number}
    * @memberof JobTitlesApiListByTenantId
    */
...
/**
 * JobTitlesApiGenerated - object-oriented interface
 * @export
 * @class JobTitlesApiGenerated
 * @extends {BaseAPI}
 */
export class JobTitlesApiGenerated extends BaseAPI {
    /**
     * Job Titles are configured at a Tenant level, unlike most other objects which are configured at a Legal Entity level.  Data Access: View Tenant Job Titles
     * @summary Get All Job Titles by Tenant ID
     * @param {JobTitlesApiListByTenantIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof JobTitlesApiGenerated
     */
    public listByTenantId(requestParameters: JobTitlesApiListByTenantIdRequest, options?: AxiosRequestConfig) {
        return JobTitlesApiFp(this.configuration).listByTenantId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
