...
// @ts-ignore
import { PagedResultOfLaborCategories } from '../models';
// @ts-ignore
...
/**
 * LaborCategoriesApi - axios parameter creator
 * @export
 */
export const LaborCategoriesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {number} legalEntityId ID of the Legal Entity for which you want to get labor categories (also known as job categories)
         * @param {string} [continuationToken] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        byLegalEntityIdGet: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalEntityId' is not null or undefined
            assertParamExists('byLegalEntityIdGet', 'legalEntityId', legalEntityId)
            const localVarPath = `/v1/legalentities/{legalEntityId}/laborcategories`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/laborcategories',
                httpMethod: 'GET'
            });
...
/**
 * LaborCategoriesApi - functional programming interface
 * @export
 */
export const LaborCategoriesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LaborCategoriesApiAxiosParamCreator(configuration)
    return {
        /**
         * To make this call you will need the Job Costing or Workforce Management Service.  Data Access: View Labor Categories by Legal Entity Id
         * @summary Get Labor Categories by Legal Entity ID
         * @param {LaborCategoriesApiByLegalEntityIdGetRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async byLegalEntityIdGet(requestParameters: LaborCategoriesApiByLegalEntityIdGetRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfLaborCategories>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.byLegalEntityIdGet(requestParameters.legalEntityId, requestParameters.continuationToken, options);
...
/**
 * LaborCategoriesApi - factory interface
 * @export
 */
export const LaborCategoriesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LaborCategoriesApiFp(configuration)
    return {
        /**
         * To make this call you will need the Job Costing or Workforce Management Service.  Data Access: View Labor Categories by Legal Entity Id
         * @summary Get Labor Categories by Legal Entity ID
         ...
         * @throws {RequiredError}
         */
        byLegalEntityIdGet(requestParameters: LaborCategoriesApiByLegalEntityIdGetRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfLaborCategories> {
            return localVarFp.byLegalEntityIdGet(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for byLegalEntityIdGet operation in LaborCategoriesApi.
 * @export
 * @interface LaborCategoriesApiByLegalEntityIdGetRequest
 */
export type LaborCategoriesApiByLegalEntityIdGetRequest = {
    
    /**
    * ID of the Legal Entity for which you want to get labor categories (also known as job categories)
    * @type {number}
    * @memberof LaborCategoriesApiByLegalEntityIdGet
    */
...
/**
 * LaborCategoriesApiGenerated - object-oriented interface
 * @export
 * @class LaborCategoriesApiGenerated
 * @extends {BaseAPI}
 */
export class LaborCategoriesApiGenerated extends BaseAPI {
    /**
     * To make this call you will need the Job Costing or Workforce Management Service.  Data Access: View Labor Categories by Legal Entity Id
     * @summary Get Labor Categories by Legal Entity ID
     * @param {LaborCategoriesApiByLegalEntityIdGetRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LaborCategoriesApiGenerated
     */
    public byLegalEntityIdGet(requestParameters: LaborCategoriesApiByLegalEntityIdGetRequest, options?: AxiosRequestConfig) {
        return LaborCategoriesApiFp(this.configuration).byLegalEntityIdGet(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
