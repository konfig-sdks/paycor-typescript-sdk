...
// @ts-ignore
import { TimeOffRequestsErrorLog } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * LegalEntityTimeDataApi - axios parameter creator
 * @export
 */
export const LegalEntityTimeDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @param {string} trackingId ID of the Employee Timeoff Request failure result.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getTimeOffRequestErrorLogsByTrackingId: async (legalEntityId: number, trackingId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalEntityId' is not null or undefined
            assertParamExists('getTimeOffRequestErrorLogsByTrackingId', 'legalEntityId', legalEntityId)
            // verify required parameter 'trackingId' is not null or undefined
            assertParamExists('getTimeOffRequestErrorLogsByTrackingId', 'trackingId', trackingId)
            const localVarPath = `/v1/legalentities/{legalEntityId}/timeoffRequestserrorlog/{trackingId}`
                .replace(`{${"legalEntityId"}}`, encodeURIComponent(String(legalEntityId !== undefined ? legalEntityId : `-legalEntityId-`)))
                .replace(`{${"trackingId"}}`, encodeURIComponent(String(trackingId !== undefined ? trackingId : `-trackingId-`)));
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/timeoffRequestserrorlog/{trackingId}',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityTimeDataApi - functional programming interface
 * @export
 */
export const LegalEntityTimeDataApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityTimeDataApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Timeoff Requests by Timeoff Request Id
         * @summary Get Employee Timeoff Request error logs by Legal Entity Id And Tracking Id
         * @param {LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getTimeOffRequestErrorLogsByTrackingId(requestParameters: LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TimeOffRequestsErrorLog>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getTimeOffRequestErrorLogsByTrackingId(requestParameters.legalEntityId, requestParameters.trackingId, options);
...
/**
 * LegalEntityTimeDataApi - factory interface
 * @export
 */
export const LegalEntityTimeDataApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityTimeDataApiFp(configuration)
    return {
        /**
         * Data Access: View Timeoff Requests by Timeoff Request Id
         * @summary Get Employee Timeoff Request error logs by Legal Entity Id And Tracking Id
         ...
         * @throws {RequiredError}
         */
        getTimeOffRequestErrorLogsByTrackingId(requestParameters: LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest, options?: AxiosRequestConfig): AxiosPromise<TimeOffRequestsErrorLog> {
            return localVarFp.getTimeOffRequestErrorLogsByTrackingId(requestParameters, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * Request parameters for getTimeOffRequestErrorLogsByTrackingId operation in LegalEntityTimeDataApi.
 * @export
 * @interface LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest
 */
export type LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest = {
    
    /**
    * ID of the Legal Entity for which you want to get the Timeoff Request.
    * @type {number}
    * @memberof LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingId
    */
...
/**
 * LegalEntityTimeDataApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityTimeDataApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityTimeDataApiGenerated extends BaseAPI {
    /**
     * Data Access: View Timeoff Requests by Timeoff Request Id
     * @summary Get Employee Timeoff Request error logs by Legal Entity Id And Tracking Id
     * @param {LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityTimeDataApiGenerated
     */
    public getTimeOffRequestErrorLogsByTrackingId(requestParameters: LegalEntityTimeDataApiGetTimeOffRequestErrorLogsByTrackingIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityTimeDataApiFp(this.configuration).getTimeOffRequestErrorLogsByTrackingId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
