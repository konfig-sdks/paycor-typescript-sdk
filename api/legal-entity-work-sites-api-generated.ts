...
// @ts-ignore
import { PagedResultOfWorkSite } from '../models';
// @ts-ignore
...
/**
 * LegalEntityWorkSitesApi - axios parameter creator
 * @export
 */
export const LegalEntityWorkSitesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: View Legal Entity Work Sites
         * @summary Get Work Sites for Legal Entity
         * @param {number} legalEntityId ID of the Legal Entity you want to get Work Sites
        ...
        getByLegalEntityId: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/legalentities/{legalEntityId}/worksites`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/worksites',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityWorkSitesApi - functional programming interface
 * @export
 */
export const LegalEntityWorkSitesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityWorkSitesApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Legal Entity Work Sites
         * @summary Get Work Sites for Legal Entity
         * @param {LegalEntityWorkSitesApiGetByLegalEntityIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByLegalEntityId(requestParameters: LegalEntityWorkSitesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfWorkSite>> {
...
/**
 * LegalEntityWorkSitesApi - factory interface
 * @export
 */
export const LegalEntityWorkSitesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityWorkSitesApiFp(configuration)
    return {
        /**
         * Data Access: View Legal Entity Work Sites
         * @summary Get Work Sites for Legal Entity
         ...
         * @throws {RequiredError}
         */
        getByLegalEntityId(requestParameters: LegalEntityWorkSitesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfWorkSite> {
...
/**
 * Request parameters for getByLegalEntityId operation in LegalEntityWorkSitesApi.
 * @export
 * @interface LegalEntityWorkSitesApiGetByLegalEntityIdRequest
 */
export type LegalEntityWorkSitesApiGetByLegalEntityIdRequest = {
    
    /**
    * ID of the Legal Entity you want to get Work Sites
    * @type {number}
    * @memberof LegalEntityWorkSitesApiGetByLegalEntityId
    */
...
/**
 * LegalEntityWorkSitesApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityWorkSitesApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityWorkSitesApiGenerated extends BaseAPI {
    /**
     * Data Access: View Legal Entity Work Sites
     * @summary Get Work Sites for Legal Entity
     * @param {LegalEntityWorkSitesApiGetByLegalEntityIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityWorkSitesApiGenerated
     */
    public getByLegalEntityId(requestParameters: LegalEntityWorkSitesApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityWorkSitesApiFp(this.configuration).getByLegalEntityId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
