...
// @ts-ignore
import { EmployeeCustomField } from '../models';
// @ts-ignore
import { EmployeeCustomField2 } from '../models';
// @ts-ignore
...
/**
 * EmployeeCustomFieldsApi - axios parameter creator
 * @export
 */
export const EmployeeCustomFieldsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: View Employee Custom Fields
         * @summary Get Employee Custom Fields by EmployeeID
         * @param {string} employeeId ID of the employee for whom you want to get the custom fields
         * @param {string} [continuationToken] Token to get the next set of employee custom fields
        ...
        getByEmployeeId: async (employeeId: string, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/employees/{employeeId}/customfields`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/employees/{employeeId}/customfields',
                httpMethod: 'GET'
            });
         ...
         * @param {string} employeeId ID of an Employee for whom you want to update the custom field
         * @param {Array<EmployeeCustomField2>} employeeCustomField2 CustomFields object
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateByEmployeeId: async (employeeId: string, employeeCustomField2: Array<EmployeeCustomField2>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'employeeId' is not null or undefined
            assertParamExists('updateByEmployeeId', 'employeeId', employeeId)
            // verify required parameter 'employeeCustomField2' is not null or undefined
            assertParamExists('updateByEmployeeId', 'employeeCustomField2', employeeCustomField2)
            const localVarPath = `/v1/employees/{employeeId}/customfields`
                .replace(`{${"employeeId"}}`, encodeURIComponent(String(employeeId !== undefined ? employeeId : `-employeeId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            ...
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            requestBeforeHook({
                requestBody: employeeCustomField2,
                queryParameters: localVarQueryParameter,
                requestConfig: localVarRequestOptions,
                path: localVarPath,
                configuration,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(employeeCustomField2, localVarRequestOptions, configuration)
...
/**
 * EmployeeCustomFieldsApi - functional programming interface
 * @export
 */
export const EmployeeCustomFieldsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = EmployeeCustomFieldsApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Employee Custom Fields
         * @summary Get Employee Custom Fields by EmployeeID
         * @param {EmployeeCustomFieldsApiGetByEmployeeIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByEmployeeId(requestParameters: EmployeeCustomFieldsApiGetByEmployeeIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<EmployeeCustomField>>> {
         ...
         * Data Access: Update Employee Custom Fields
         * @summary Update Custom Field by EmployeeID
         * @param {EmployeeCustomFieldsApiUpdateByEmployeeIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async updateByEmployeeId(requestParameters: EmployeeCustomFieldsApiUpdateByEmployeeIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateOrUpdateResponse>> {
            const employeeCustomField2: Array<EmployeeCustomField2> = requestParameters.requestBody;
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateByEmployeeId(requestParameters.employeeId, employeeCustomField2, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * EmployeeCustomFieldsApi - factory interface
 * @export
 */
export const EmployeeCustomFieldsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = EmployeeCustomFieldsApiFp(configuration)
    return {
        /**
         * Data Access: View Employee Custom Fields
         * @summary Get Employee Custom Fields by EmployeeID
         ...
         * @throws {RequiredError}
         */
        getByEmployeeId(requestParameters: EmployeeCustomFieldsApiGetByEmployeeIdRequest, options?: AxiosRequestConfig): AxiosPromise<Array<EmployeeCustomField>> {
         ...
         * @throws {RequiredError}
         */
        updateByEmployeeId(requestParameters: EmployeeCustomFieldsApiUpdateByEmployeeIdRequest, options?: AxiosRequestConfig): AxiosPromise<CreateOrUpdateResponse> {
...
/**
 * Request parameters for getByEmployeeId operation in EmployeeCustomFieldsApi.
 * @export
 * @interface EmployeeCustomFieldsApiGetByEmployeeIdRequest
 */
export type EmployeeCustomFieldsApiGetByEmployeeIdRequest = {
    
    /**
    * ID of the employee for whom you want to get the custom fields
    * @type {string}
    * @memberof EmployeeCustomFieldsApiGetByEmployeeId
    */
...
/**
 * Request parameters for updateByEmployeeId operation in EmployeeCustomFieldsApi.
 * @export
 * @interface EmployeeCustomFieldsApiUpdateByEmployeeIdRequest
 */
export type EmployeeCustomFieldsApiUpdateByEmployeeIdRequest = {
    /**
    * ID of an Employee for whom you want to update the custom field
    * @type {string}
    * @memberof EmployeeCustomFieldsApiUpdateByEmployeeId
    */
    readonly employeeId: string
    /**
    * CustomFields object
    * @type {Array<EmployeeCustomField2>}
    * @memberof EmployeeCustomFieldsApiUpdateByEmployeeId
    */
    readonly requestBody: Array<EmployeeCustomField2>
}

/**
 * EmployeeCustomFieldsApiGenerated - object-oriented interface
 * @export
 * @class EmployeeCustomFieldsApiGenerated
 * @extends {BaseAPI}
 */
export class EmployeeCustomFieldsApiGenerated extends BaseAPI {
    /**
     * Data Access: View Employee Custom Fields
     * @summary Get Employee Custom Fields by EmployeeID
     * @param {EmployeeCustomFieldsApiGetByEmployeeIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof EmployeeCustomFieldsApiGenerated
     */
    public getByEmployeeId(requestParameters: EmployeeCustomFieldsApiGetByEmployeeIdRequest, options?: AxiosRequestConfig) {
        return EmployeeCustomFieldsApiFp(this.configuration).getByEmployeeId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof EmployeeCustomFieldsApiGenerated
     */
    public updateByEmployeeId(requestParameters: EmployeeCustomFieldsApiUpdateByEmployeeIdRequest, options?: AxiosRequestConfig) {
        return EmployeeCustomFieldsApiFp(this.configuration).updateByEmployeeId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
