...
// @ts-ignore
import { PagedResultOfScheduleGroup } from '../models';
// @ts-ignore
...
/**
 * LegalEntityScheduleGroupsApi - axios parameter creator
 * @export
 */
export const LegalEntityScheduleGroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: View Legal Entity Schedule Groups
         * @summary Get Schedules Groups for Legal Entity
         * @param {number} legalEntityId ID of the Legal Entity you want to get Schedule Groups
         * @param {string} [continuationToken] A token to get next set of results
        ...
        getByLegalEntityId: async (legalEntityId: number, continuationToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/v1/legalentities/{legalEntityId}/schedulegroups`
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/schedulegroups',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityScheduleGroupsApi - functional programming interface
 * @export
 */
export const LegalEntityScheduleGroupsApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityScheduleGroupsApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: View Legal Entity Schedule Groups
         * @summary Get Schedules Groups for Legal Entity
         * @param {LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getByLegalEntityId(requestParameters: LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PagedResultOfScheduleGroup>> {
...
/**
 * LegalEntityScheduleGroupsApi - factory interface
 * @export
 */
export const LegalEntityScheduleGroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityScheduleGroupsApiFp(configuration)
    return {
        /**
         * Data Access: View Legal Entity Schedule Groups
         * @summary Get Schedules Groups for Legal Entity
         ...
         * @throws {RequiredError}
         */
        getByLegalEntityId(requestParameters: LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig): AxiosPromise<PagedResultOfScheduleGroup> {
...
/**
 * Request parameters for getByLegalEntityId operation in LegalEntityScheduleGroupsApi.
 * @export
 * @interface LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest
 */
export type LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest = {
    
    /**
    * ID of the Legal Entity you want to get Schedule Groups
    * @type {number}
    * @memberof LegalEntityScheduleGroupsApiGetByLegalEntityId
    */
...
/**
 * LegalEntityScheduleGroupsApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityScheduleGroupsApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityScheduleGroupsApiGenerated extends BaseAPI {
    /**
     * Data Access: View Legal Entity Schedule Groups
     * @summary Get Schedules Groups for Legal Entity
     * @param {LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityScheduleGroupsApiGenerated
     */
    public getByLegalEntityId(requestParameters: LegalEntityScheduleGroupsApiGetByLegalEntityIdRequest, options?: AxiosRequestConfig) {
        return LegalEntityScheduleGroupsApiFp(this.configuration).getByLegalEntityId(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
