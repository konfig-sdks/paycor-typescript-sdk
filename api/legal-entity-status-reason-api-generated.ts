...
// @ts-ignore
import { StatusCategory2 } from '../models';
// @ts-ignore
import { StatusReason } from '../models';
import { paginate } from "../pagination/paginate";
import type * as buffer from "buffer"
import { requestBeforeHook } from '../requestBeforeHook';
/**
 * LegalEntityStatusReasonApi - axios parameter creator
 * @export
 */
export const LegalEntityStatusReasonApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Data Access: Legal Entity Status Reason
         * @summary Get Legal Entity Status Reason values
         * @param {number} legalEntityId ID of the legal entity for which you want to get the status reasons items
         * @param {StatusCategory2} statusCategory Status category of status reasons.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getList: async (legalEntityId: number, statusCategory: StatusCategory2, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'legalEntityId' is not null or undefined
            assertParamExists('getList', 'legalEntityId', legalEntityId)
            // verify required parameter 'statusCategory' is not null or undefined
            assertParamExists('getList', 'statusCategory', statusCategory)
            const localVarPath = `/v1/legalentities/{legalEntityId}/statusReasons/{statusCategory}`
                .replace(`{${"legalEntityId"}}`, encodeURIComponent(String(legalEntityId !== undefined ? legalEntityId : `-legalEntityId-`)))
                .replace(`{${"statusCategory"}}`, encodeURIComponent(String(statusCategory !== undefined ? statusCategory : `-statusCategory-`)));
            ...
            requestBeforeHook({
                ...
                path: localVarPath,
                configuration,
                pathTemplate: '/v1/legalentities/{legalEntityId}/statusReasons/{statusCategory}',
                httpMethod: 'GET'
            });
...
/**
 * LegalEntityStatusReasonApi - functional programming interface
 * @export
 */
export const LegalEntityStatusReasonApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = LegalEntityStatusReasonApiAxiosParamCreator(configuration)
    return {
        /**
         * Data Access: Legal Entity Status Reason
         * @summary Get Legal Entity Status Reason values
         * @param {LegalEntityStatusReasonApiGetListRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getList(requestParameters: LegalEntityStatusReasonApiGetListRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<StatusReason>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getList(requestParameters.legalEntityId, requestParameters.statusCategory, options);
...
/**
 * LegalEntityStatusReasonApi - factory interface
 * @export
 */
export const LegalEntityStatusReasonApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = LegalEntityStatusReasonApiFp(configuration)
    return {
        /**
         * Data Access: Legal Entity Status Reason
         * @summary Get Legal Entity Status Reason values
         ...
         * @throws {RequiredError}
         */
        getList(requestParameters: LegalEntityStatusReasonApiGetListRequest, options?: AxiosRequestConfig): AxiosPromise<Array<StatusReason>> {
...
/**
 * Request parameters for getList operation in LegalEntityStatusReasonApi.
 * @export
 * @interface LegalEntityStatusReasonApiGetListRequest
 */
export type LegalEntityStatusReasonApiGetListRequest = {
    
    /**
    * ID of the legal entity for which you want to get the status reasons items
    * @type {number}
    * @memberof LegalEntityStatusReasonApiGetList
    */
    ...
    * @memberof LegalEntityStatusReasonApiGetList
    */
    readonly statusCategory: StatusCategory2
    
}

/**
 * LegalEntityStatusReasonApiGenerated - object-oriented interface
 * @export
 * @class LegalEntityStatusReasonApiGenerated
 * @extends {BaseAPI}
 */
export class LegalEntityStatusReasonApiGenerated extends BaseAPI {
    /**
     * Data Access: Legal Entity Status Reason
     * @summary Get Legal Entity Status Reason values
     * @param {LegalEntityStatusReasonApiGetListRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LegalEntityStatusReasonApiGenerated
     */
    public getList(requestParameters: LegalEntityStatusReasonApiGetListRequest, options?: AxiosRequestConfig) {
        return LegalEntityStatusReasonApiFp(this.configuration).getList(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
}
